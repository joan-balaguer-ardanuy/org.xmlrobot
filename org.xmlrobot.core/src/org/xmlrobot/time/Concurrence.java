...
public abstract class Concurrence
	 ...
	 * @param gen {@link Parity} the gender
	 */
	public Concurrence(Class<? extends K> type, Parity gen, V child) {
	 ...
	 * @param gen {@link Parity} the gender
	 */
	public Concurrence(K root, Parity gen) {
		super(root, gen);
	}
	/**
	 * {@link Concurrence} class constructor.
	 ...
	 * @param child the child
	 */
	public Concurrence(K root, Parity gen, V child) {
	...
	/* (non-Javadoc)
	 * @see org.xmlrobot.time.Concurrent#getNextValue()
	 */
	@Override
	public V getNextChild() {
		return getChild().getPreviousParent();
	}
	/* (non-Javadoc)
